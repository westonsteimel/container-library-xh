...
version=`curl --silent "https://api.github.com/repos/ducaale/xh/releases/latest" | jq .tag_name | xargs`
revision=`curl --silent "https://api.github.com/repos/ducaale/xh/commits/${version}" | jq .sha | xargs`
version=${version#"v"}
